package de.css_lims.dkmsroboterrueckmeldung.dkms.misc;
...
public class ParseParenthesizedString {
    ...
    public void Answer() {
        String theString = "content (content1 (content1-1, content1-2) content2 (content2-1 (content2-1-1, content2-1-2)))";
        // wants:
        ...
        for (int i = 0; i < theString.length(); i++) {
            ...
            case ')':
                {
                    if (state == States.STARTING) { /* this is an error */
    ...
    public static void PrintArrayList(ArrayList<String> theList) {
        System.out.println("The ArrayList with " + theList.size() + " elements:");
