...
public class DkmsRoboterRueckmeldungRequestClient {
    ...
    public static void main(String[] args) {
        ...
        rueckmeldungRequest =
            initializeStaticRueckmeldungRequest(1, "DNAplateId", "Tecan_Evo01", "011", "boehm", "boehm", "");
    ...
    private static void createObjektList(List<WertObjekt> wObjektList, EnumMap<? extends Enum, String> werteMap) {
        ...
        public static RueckmeldungRequest initializeStaticRueckmeldungRequest(int requestTyp, String rackId,
