 ...
 *         &lt;element name="rackTypId" type="{http://www.w3.org/2001/XMLSchema}string"/&gt;
...
@XmlType(name = "",
         ...
         { "requestTyp", "requestId", "hinweisText", "roboterId", "programmId", "userBedienerId", "userKontrolleurId",
           "zeitstempel", "rackId", "rackTypId", "dynamischerTeil"
    })
@XmlRootElement(name = "RackErzeugenRequest")
public class RackErzeugenRequest {
    ...
    @XmlElement(required = true, nillable = true)
    protected String rackTypId;
    @XmlElement(required = true)
    protected RackErzeugenRequest.DynamischerTeil dynamischerTeil;
    ...
    /**
     * Gets the value of the rackTypId property.
     *
     * @return
     *     possible object is
     *     {@link String }
     *
     */
    public String getRackTypId() {
        return rackTypId;
    }

    /**
     * Sets the value of the rackTypId property.
     *
     * @param value
     *     allowed object is
     *     {@link String }
     *
     */
    public void setRackTypId(String value) {
        this.rackTypId = value;
    }
     ...
     * @return
     *     possible object is
     *     {@link RackErzeugenRequest.DynamischerTeil }
     *
     */
    public RackErzeugenRequest.DynamischerTeil getDynamischerTeil() {
     ...
     *
     */
    public void setDynamischerTeil(RackErzeugenRequest.DynamischerTeil value) {
    ...
    public static class DynamischerTeil {
        ...
        @XmlElement(required = true)
        protected List<RackErzeugenRequest.DynamischerTeil.DynamischerTyp> dynamischerTyp;
         ...
         * {@link RackErzeugenRequest.DynamischerTeil.DynamischerTyp }
         *
         *
         */
        public List<RackErzeugenRequest.DynamischerTeil.DynamischerTyp> getDynamischerTyp() {
            if (dynamischerTyp == null) {
                dynamischerTyp = new ArrayList<RackErzeugenRequest.DynamischerTeil.DynamischerTyp>();
            }
        ...
        public static class DynamischerTyp {
            ...
            @XmlElement(required = true)
            protected List<RackErzeugenRequest.DynamischerTeil.DynamischerTyp.DynamischesObjekt> dynamischesObjekt;
             ...
             * <p>
             * Objects of the following type(s) are allowed in the list
             * {@link RackErzeugenRequest.DynamischerTeil.DynamischerTyp.DynamischesObjekt }
             *
             *
             */
            public List<RackErzeugenRequest.DynamischerTeil.DynamischerTyp.DynamischesObjekt> getDynamischesObjekt() {
                if (dynamischesObjekt == null) {
                    dynamischesObjekt =
                        new ArrayList<RackErzeugenRequest.DynamischerTeil.DynamischerTyp.DynamischesObjekt>();
                }
            ...
            public static class DynamischesObjekt {
                ...
                @XmlElement(required = true)
                protected List<RackErzeugenRequest.DynamischerTeil.DynamischerTyp.DynamischesObjekt.WertObjekt> wertObjekt;
                 ...
                 * <p>
                 * Objects of the following type(s) are allowed in the list
                 * {@link RackErzeugenRequest.DynamischerTeil.DynamischerTyp.DynamischesObjekt.WertObjekt }
                 *
                 *
                 */
                public List<RackErzeugenRequest.DynamischerTeil.DynamischerTyp.DynamischesObjekt.WertObjekt> getWertObjekt() {
                    if (wertObjekt == null) {
                        wertObjekt =
                            new ArrayList<RackErzeugenRequest.DynamischerTeil.DynamischerTyp.DynamischesObjekt.WertObjekt>();
                    }
